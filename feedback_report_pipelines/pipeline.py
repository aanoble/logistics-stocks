...
@parameter(
    "fp_site_attendus",
    name="Chemin d'accès au fichier liste des sites attendus",
    type=str,
    required=True,
    help="Chemin d'accès au fichier Liste des sites Attendus chargé au préalable sur OpenHexa dans le dossier `Rapport Feedback/data/Sites attendus`.",
)
@parameter(
    "fp_prod_traceurs",
    name="Chemin d'accès au fichier liste des produits traceurs",
    type=str,
    required=True,
    help="Chemin d'accès au fichier Liste des produits traceurs chargé au préalabe sur OpenHexa dans le dossier `Rapport Feedback/data/Produits Traceurs`",
)
