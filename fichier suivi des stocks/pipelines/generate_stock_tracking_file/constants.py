...
DICO_FORMULES_ANNEXE_2 = {
    ...
    4: "='Annexe 1 - Consolidation'!C{0}",  # DESIGNATION DU PRODUIT
    5: "='Annexe 1 - Consolidation'!D{0}",  # Type
    ...
    32: "=IF(AK{0}=0,\"\",SUMIFS('Plan d''appro'!J:J,'Plan d''appro'!A:A,A{0},'Plan d''appro'!F:F, AK{0}))",  # Qtité attendue
