...
def upload_and_return_link(file_path, date_report, parent_id='1LHsczOhs4f5Z4DZkuMiiYGiwj_ppKb_Z', method='download'):
    assert method in ('share', 'download'), "Le paramètre ne prend que les valeurs ('share', 'download')"
